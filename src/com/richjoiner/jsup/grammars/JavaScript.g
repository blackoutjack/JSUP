...
memberExpression
    :  memberExpressionPrefix (LT* memberExpressionSuffix)*
	-> ^(MEMBERCHAIN memberExpressionPrefix memberExpressionSuffix*)
	;

memberExpressionPrefix
...
callExpression
    ...
    -> ^(CALL memberExpression arguments callExpressionSuffix*)
	;
...
arguments
	: '(' (LT* assignmentExpression (LT* ',' LT* assignmentExpression)*)? LT* ')' -> ^(ARGUMENTS ^(ARGUMENT assignmentExpression)* )
	;
...
regExpLiteral
    ...
    -> ^(REGEXP regExpFirstCharacter regExpCharacter*)
	;
